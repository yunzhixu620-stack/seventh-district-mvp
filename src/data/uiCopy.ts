...
export const ui = {
  ...
  landingTag: { zhCN: '都市角色扮演夜局 / 身份未知', en: 'URBAN ROLEPLAY NIGHT / HIDDEN IDENTITIES' },
  ...
  castIntro: { zhCN: '先认清今夜可能与你周旋的人，再选择一个身份入场。', en: 'Know the people in tonight\'s session, then enter as one of them.' },
  ...
  sessionRule: { zhCN: '局内不公布幕后控制类型。你只能从行动、矛盾与局后报告判断。', en: 'Control types stay hidden during play. Judge only from actions, contradictions, and the post-game report.' },
